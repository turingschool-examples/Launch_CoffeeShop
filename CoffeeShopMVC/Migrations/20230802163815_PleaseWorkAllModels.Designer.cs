...
namespace CoffeeShopMVC.Migrations
{
    ...
    [Migration("20230802163815_PleaseWorkAllModels")]
    partial class PleaseWorkAllModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoffeeShopMVC.Models.Order", b =>
                {
                    ...
                    b.HasIndex("OrderCustomerId")
                        .HasDatabaseName("ix_order_order_customer_id");
            ...
            modelBuilder.Entity("CoffeeShopMVC.Models.Order", b =>
                {
                    b.HasOne("CoffeeShopMVC.Models.Customer", "OrderCustomer")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_customers_order_customer_id");
